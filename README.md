...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/djongo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11574&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/djongo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `djongo` can be installed with:

```
conda install djongo
```

It is possible to list all of the versions of `djongo` available on your platform with:
